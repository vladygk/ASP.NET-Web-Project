...
{
    static readonly IEnumerable<FoodType> _dietYoung = new HashSet<FoodType>() { new Fruit()};
    static readonly IEnumerable<FoodType> _dietMature = new HashSet<FoodType>() {new Fruit(),new Vegetable() };
